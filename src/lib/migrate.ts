...
import { connect, kwilDB } from 'src/configs/kwilconf';
...
export class Migrate {
    ...
    private kwildb = kwilDB;


    constructor(options: { mysqlconn: Database}) {
     ...
     * @memberof Migrate
     */
    public async generateKwilSchemas(): Promise<void> {
        ...
        for await (const schemafile of schemafiles) {
            ...
            // add key value pairs to modelschemas, to map data-files to their corresponding kwil-model files
            ...
            try {
                ...
                // console.log('schema creation query\n')
     ...
     * @memberof Migrate
     */
    public async populateKwil(): Promise<void> {
